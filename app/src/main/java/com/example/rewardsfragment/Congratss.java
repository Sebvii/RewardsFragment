...
public class Congratss extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_congratss); // Ensure this XML file exists
    ...
    private void navigateToHome() {
        Intent intent = new Intent(Congratss.this, MainActivity.class); // Change to the correct destination activity
