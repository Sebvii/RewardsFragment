...
public class Playmaker extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_playmaker); // Ensure this XML file exists
    ...
    private void navigateToHome() {
        Intent intent = new Intent(Playmaker.this, MainActivity.class); // Change to the correct destination activity
